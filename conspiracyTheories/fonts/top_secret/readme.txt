...
Pe³na wersja fonta sk³ada siê  z rodziny:  

Top secret ( udostêpnione sharweware)
top secret splash (komercyjne) 
top secret shadow (komercyjne)
top secret college (komercyjne)
top secret distorted (komercyjne) 
top secret italic (komercyjne)

RODZINA  W WESJI KOMERCYJNEJ POSIADA WSZYSTKIE ZNAKI  ZAWARTE W  TABELACH KODOWAÑ 
WIN 1250 
    1252 LATIN 
...
Jeœli chesz u¿ywaæ tego fonta w celach komercyjnych proszê o kontakt. Cena za ca³¹ rodzinê fonta to równowartoœæ 15 $ w pln.  
...
----------------------------------------------------------------------------------------------------
The font TOP SECRET  that was designed by me,
...
Top secret sharweware)
top secret splash (COMMERCIAL) 
top secret shadow (COMMERCIAL)
top secret college (COMERCIAL)
top secret distorted (COMMERCIAL) 
top secret italic (COMMERCIAL)
...
Hope you like TOP SECRET and it will be
useful in your work :)
